...
# ============================================================
set_multicycle_path -setup -from [get_registers {*DCon_audio_z80*}] -to [get_registers {*DCon_audio_z80*}] 24
set_multicycle_path -hold  -from [get_registers {*DCon_audio_z80*}] -to [get_registers {*DCon_audio_z80*}] 23
