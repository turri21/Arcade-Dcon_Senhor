...
// sdram_bridge — Bridge e arbitro SDRAM per DCon.
...
localparam [23:0] TXT_BASE    = 24'h040000;  // 128KB txtiles
localparam [23:0] BG_BASE     = 24'h050000;  // 512KB bgtiles
localparam [23:0] FG_BASE     = 24'h090000;  // 512KB fgtiles
localparam [23:0] MG_BASE     = 24'h0D0000;  // 1024KB mgtiles
localparam [23:0] SPR_BASE    = 24'h150000;  // 2048KB sprites
...
// ================================================================
// PORT 2: SDRAM bank 2 — UNUSED (DCon ha 1 sola CPU 68k).
// Pin SDRAM richiesti dal sys_top: tied off statici.
// ================================================================
always @(posedge clk) begin
	if (reset) sdram_req2 <= 1'b0;
end
always @(*) sdram_addr2 = {2'b10, 22'd0};
